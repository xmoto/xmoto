...
public:
  ...
  */
  ...
  /* stats */
  void stats_createProfile(const std::string &i_sitekey,
                           const std::string &i_profile);
  void stats_destroyProfile(const std::string &i_profile);
  bool stats_checkKeyExists_stats_profiles(const std::string &i_sitekey,
                                           const std::string &i_profile);
  ...
  void stats_levelRestarted(const std::string &i_sitekey,
                            ...
                            const std::string &LevelID,
                            int i_playTime);
  void stats_xmotoStarted(const std::string &i_sitekey,
                          const std::string &PlayerName);

  /* levels */
  void levels_updateDB(
    const std::vector<Level *> &i_levels,
    bool i_isToReload,
  ...
  void levels_addToFavorite(const std::string &i_profile,
                            const std::string &i_id_level);
  void levels_delToFavorite(const std::string &i_profile,
                            const std::string &i_id_level);
  void levels_addToBlacklist(const std::string &i_profile,
                             const std::string &i_id_level);
  void levels_delToBlacklist(const std::string &i_profile,
                             const std::string &i_id_level);
  ...
  bool levels_add_fast(const std::string &i_filepath,
  ...
  void themes_add(const std::string &i_id_theme, const std::string &i_filepath);
  ...
  bool markMyHighscoresKnownStolen(const std::string &i_id_profile,
  ...
  bool config_getBool(const std::string &i_id_profile,
                      const std::string &i_key,
                      bool i_default);
  int config_getInteger(const std::string &i_id_profile,
                        const std::string &i_key,
                        int i_default);
  float config_getFloat(const std::string &i_id_profile,
                        const std::string &i_key,
                        float i_default);
  void config_setString(const std::string &i_id_profile,
                        const std::string &i_key,
                        const std::string &i_value);
  void config_setBool(const std::string &i_id_profile,
                      const std::string &i_key,
                      bool i_value);
  void config_setInteger(const std::string &i_id_profile,
                         const std::string &i_key,
                         int i_value);
  void config_setFloat(const std::string &i_id_profile,
                       const std::string &i_key,
                       float i_value);

  // sync
  std::string getXmDbSiteKey();
  void sync_buildServerFile(const std::string &i_outFile,
                            const std::string &i_sitekey,
                            const std::string &i_profile);
  void sync_updateDB(const std::string &i_profile,
                     const std::string &i_sitekey,
  ...
  void srv_addAdmin(const std::string &i_profile,
                    const std::string &i_password);
  void srv_removeAdmin(int id);
  void srv_addBan(const std::string &i_profile,
  ...
  void srv_cleanBans();
  void srv_changePassword(const std::string &i_profile,
                          const std::string &i_password);
...
private:
  ...
  static void user_xm_floord(sqlite3_context *i_context,
                             int i_nArgs,
                             sqlite3_value **i_values);
  static void user_xm_lvlUpdatedToTxt(sqlite3_context *i_context,
                                      int i_nArgs,
                                      sqlite3_value **i_values);
  static void user_xm_userCrappy(sqlite3_context *i_context,
                                 int i_nArgs,
                                 sqlite3_value **i_values);
  static void user_xm_userChildrenCompliant(sqlite3_context *i_context,
                                            int i_nArgs,
                                            sqlite3_value **i_values);
  static void user_xm_replaceStart(sqlite3_context *i_context,
                                   int i_nArgs,
                                   sqlite3_value **i_values);
  static void user_xm_profile(sqlite3_context *i_context,
                              int i_nArgs,
                              sqlite3_value **i_values);
  static void user_xm_idRoom(sqlite3_context *i_context,
                             int i_nArgs,
                             sqlite3_value **i_values);
  ...
  void updateXMDirectories(const std::string &i_oldGameDataDir,
  ...
  bool getXmParameterKey(
    const std::string &i_key,
    std::string &o_value); // get a parameter value as string
  void setXmParameterKey(
    const std::string &i_key,
    const std::string &i_value); // set a parameter value as string
  std::string config_getValue(const std::string &i_id_profile,
                              const std::string &i_key,
                              unsigned int &o_nrow);
  void config_setValue(const std::string &i_id_profile,
                       const std::string &i_key,
                       const std::string &i_value);

  /* if i_sitekey is empty, don't care of it -- require for old db without
   * sitekey */
  void updateDB_config(
    const std::string &i_sitekey); /* conversion of the old file values */
  ...
  void updateDB_stats(
    XmDatabaseUpdateInterface *i_interface = NULL); /* statistics */
  void updateDB_favorite(
    const std::string &i_profile,
  ...
  void updateDB_profiles(
    XmDatabaseUpdateInterface *i_interface = NULL); /* profiles */

  /* web */
  bool webrooms_checkKeyExists_id_room(const std::string &i_id_room);
  void webrooms_addRoom(const std::string &i_id_room,
                        const std::string &i_name,
                        const std::string &i_highscoreUrl);
  void webthemes_addTheme(const std::string &i_id_theme,
