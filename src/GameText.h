...
#define GAMETEXT_NOMULTISCENES        _("Semi-collaborativ mode")
...
#define GAMETEXT_UPLOAD_HIGHSCORE_ERROR _("An unexpected error has occured. There may be some problems with the web site.")
