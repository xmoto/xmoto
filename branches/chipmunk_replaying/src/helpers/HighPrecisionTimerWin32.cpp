...
/* WARNING: This file is very non-portable; don't expect it to run on exotic windows platforms,
            only x86 */
            
#define MAX_TIME_CHECKS       32
#define MOVING_AVG_LEN        250  /* times are averaged out over this number of samples */
...
HighPrecisionTimer::TimeCheck *HighPrecisionTimer::getTimeCheck(int nIdx) {
  if(nIdx < 0 || nIdx >= g_nNumTimeChecks) return NULL;
