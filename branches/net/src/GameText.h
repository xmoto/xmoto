...
#define GAMETEXT_DISPLAYGHOSTARROW    _("Display Ghost arrow")
...
#define CONTEXTHELP_DISPLAY_GHOST_ARROW _("Display an arrow to display where are located the ghosts on the map")
