...
#define GAMETEXT_ASSOCIATED_THEME     _("Current Theme")
#define GAMETEXT_STANDARD_THEME       _("Standard Theme")
...
#define GAMETEXT_BIKE_THEME           _("Bike Theme")
#define GAMETEXT_BIKES_LOCAL           _("Local")
...
#define GAMETEXT_DBSYNCHRONIZE_WARNING _("If you manually copied the X-Moto user files (.xmoto) on some other computers, you should not use this functionality otherwise your statistics will be duplicated/not synchronized. If you did that, you should remove the copies you did.")
...
#define GAMETEXT_WAIT_XMSERVER        _("Please wait the next party\nOr press escape to disconnect")
...
#define GAMETEXT_IS_VALID             _("Official Bike")
...
#define GAMETEXT_BIKE		      _("Bike")
#define GAMETEXT_BIKES		      _("Bikes")
#define GAMETEXT_BIKES_GET	      _("Download")
...
#define GAMETEXT_PHYSICS              _("Physics")
...
#define GAMETEXT_SELECT               _("Choose")
...
#define CONTEXTHELP_BIKE _("Choose your bike")
#define CONTEXTHELP_BIKE_SHOW _("View the characteristics of your bike")
#define CONTEXTHELP_BIKE_VALID _("Shows whether the bike is officially validated")
#define CONTEXTHELP_BIKE_THEME_VALID _("Shows wheter the bike theme is officially validated")
#define CONTEXTHELP_BIKE_DELETE _("Remove selected bike from the list")
#define CONTEXTHELP_BIKE_DOWNLOAD _("Get new bikes from web")
#define CONTEXTHELP_BIKE_THEME _("The current theme of the bike")
#define CONTEXTHELP_STANDARD_BIKE_THEME _("The official standard theme of the bike")
#define CONTEXTHELP_BIKE_LOCAL _("Choose from bikes on your hard disk")
...
#define CONTEXTHELP_CAMERATRAILCAM _("Use a camera that directs to the shortest path through the level")
...
#define CONTEXTHELP_FAVORITES _("Your favorite levels")
...
#define CONTEXTHELP_NETWORK _("Play against others over Network")
